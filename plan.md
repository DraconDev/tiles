...
we currently have vim keys added, we dont want this at all, strip it, we are entirely not vim based, i come to realize that by supporting it we have to have stupid hotkeys like j and k hl
