...
make sure we are opening the tabs above the filelist tab, and this means if we have a second tab we open the tabs for that starting from the top of the filelist tab
