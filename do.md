...
also if i think about it we are not mainly making a terminal emulator, cause terma is not meant to be a terminal emulator, it is meant to be the brains/library of terminal based apps right?